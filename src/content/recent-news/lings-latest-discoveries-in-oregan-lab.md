---
title: 'Pioneering Cardiovascular AI: Dr. Ling Huang’s Latest Discoveries in the O’Regan Lab'
pubDate: 'Feb-01-2026'
---
...
### Decoding the Heart at an Unprecedented Scale
In a preprint study posted in early 2026, the O'Regan Lab team set out to solve a long-standing medical mystery: *exactly how does chronic, systemic inflammation physically alter the human heart?*

To find the answer, the team analyzed subsets of nearly **500,000 UK Biobank participants**. 



The sheer scale and complexity of this data required advanced machine learning techniques. Dr. Huang and the team integrated multiple data streams, including:
* **Metabolomic and Proteomic profiles** (specifically looking at GlycA, a biomarker for chronic inflammation).
...
Furthermore, the research mapped out the complex "exposome" (environmental factors) driving this inflammation. It highlighted that factors like trunk fat mass, smoking, and psychological distress are major contributors. Most importantly, the study proved that these environmental factors interact with a patient's genetic susceptibility to dramatically influence their cardiovascular health. Patients in the highest quintile for inflammation had a 43% higher risk of major adverse cardiovascular events.
